...
public class MainActivity extends Activity implements MainFragmentInteractionListener, StreamListFragment.StreamListFragmenListener {
    ...
    private BroadcastListener mBroadcastListener = new BroadcastListener() {
        ...
        public void onBroadcastLive(Stream stream) {
            ...
            String Test = stream.getStreamUrl();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //view.setVideoURI(stream.getStreamUrl());
        // Using Kickflip


        KickflipApiClient api = new KickflipApiClient(this, SECRETS.CLIENT_KEY, SECRETS.CLIENT_SECRET, new KickflipCallback() {
            @Override
            public void onSuccess(Response response) {
        ...
        api.createNewUser("sharedmocha23", "jalsa", "pak@pak.com", "sharedmocha", null, new KickflipCallback() {
            @Override
            public void onSuccess(Response response) {
